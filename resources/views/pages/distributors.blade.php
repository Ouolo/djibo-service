...
@section('content')
    ...
    <div class="breadcrumb-area bg-color-primary py-5 text-center text-white" style="background-image: linear-gradient(135deg, #1b5e3a, #10251e);">
        <div class="container">
            ...
            <p class="lead text-warning m-0">Retrouvez facilement nos intrants et produits biologiques près de chez vous</p>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title-wrap text-center mb-5">
                        <h6 class="text-color-primary font-weight-bold mb-2">POINTS DE VENTE</h6>
                ...
                @foreach($distributors as $distributor)
                    <div class="col-lg-4 col-md-6 mb-4 wow animate__fadeInUp" data-wow-delay="0.2s">
                        <div class="card h-100 border-0 shadow-sm rounded-lg overflow-hidden d-flex flex-column justify-content-between">
                            <div class="p-4">
                                <div class="bg-success text-white py-2 px-3 rounded d-inline-block mb-3 small font-weight-bold">
                                    <i class="fas fa-store me-1"></i> Point de Vente Agréé
                                </div>
                                <h4 class="font-weight-bold text-dark mb-2">{{ $distributor['name'] }}</h4>
                                <p class="text-success font-weight-bold mb-3"><i class="fas fa-map-marker-alt me-1"></i> {{ $distributor['location'] }}</p>
                                <hr class="my-3">
                            ...
                            <div class="p-4 bg-white border-top">
                                <a href="tel:{{ str_replace(' ', '', $distributor['phone']) }}" class="btn btn-outline-success w-100 rounded-pill font-weight-bold mb-2">
                                    <i class="fas fa-phone-alt me-2"></i> {{ $distributor['phone'] }}
                                </a>
                                <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $distributor['phone']) }}?text=Bonjour,%20je%20souhaite%20acheter%20les%20produits%20Djibo%20Service" target="_blank" class="btn btn-success w-100 rounded-pill font-weight-bold text-white">
    ...
    <div class="section-space--ptb_80 bg-white">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="ps-lg-4">
                        <h6 class="text-color-primary font-weight-bold mb-2">REJOINDRE NOTRE RÉSEAU</h6>
                        ...
                        <ul class="list-unstyled mb-4 text-muted">
                            <li class="mb-2"><i class="fas fa-check-circle text-success me-2"></i> Marges bénéficiaires attractives et tarifs grossistes.</li>
                            <li class="mb-2"><i class="fas fa-check-circle text-success me-2"></i> Formations techniques gratuites sur l'usage des produits.</li>
                            <li class="mb-2"><i class="fas fa-check-circle text-success me-2"></i> Référencement de votre boutique sur nos canaux de communication.</li>
                        </ul>
                        <a href="{{ route('contact') }}" class="ht-btn ht-btn-md">
                            Postuler maintenant
                        </a>
                    </div>
                </div>
