...
@section('content')
    ...
    <div class="breadcrumb-area bg-color-primary py-5 text-center text-white" style="background-image: linear-gradient(135deg, #1b5e3a, #10251e);">
        <div class="container">
            ...
            <p class="lead text-warning m-0">Découvrez l'impact concret de nos actions sur les parcelles et communautés</p>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title-wrap text-center mb-5">
                        <h6 class="text-color-primary font-weight-bold mb-2">PROJETS MARQUANTS</h6>
                            ...
                            <div>
                                ...
                                <div class="p-4">
                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                        <span class="badge bg-warning text-dark"><i class="fas fa-map-marker-alt me-1"></i> {{ $realisation['location'] }}</span>
                                    </div>
                                    <h5 class="card-title font-weight-bold text-dark mb-2">{{ $realisation['title'] }}</h5>
                                    <h6 class="text-success font-weight-bold mb-3"><i class="fas fa-chart-line me-1"></i> Impact : {{ $realisation['impact'] }}</h6>
                                    <p class="card-text text-muted small">{{ $realisation['description'] }}</p>
                                </div>
                            </div>
                            <div class="px-4 pb-4">
                                <hr class="mt-0">
                                <a href="https://wa.me/22376543210?text=Je%20souhaite%20en%20savoir%20plus%20sur%20le%20projet%20{{ urlencode($realisation['title']) }}" target="_blank" class="btn btn-link p-0 text-decoration-none text-success font-weight-bold">
